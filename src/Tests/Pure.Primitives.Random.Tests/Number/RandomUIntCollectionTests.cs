...
public sealed record RandomUIntCollectionTests
{
    ...
    public void RangeAffectGeneration()
    {
        ...
        IEnumerable<uint> values = new RandomUIntCollection(
            new MaxUshort(),
            min,
            max
    ...
    public void ProduceNormalStandardDeviationWithSharedProvider()
    {
        ...
        [
            .. new RandomUIntCollection(new UShort(10000), random).Select(x =>
    ...
    public void ProduceNormalStandardDeviation()
    {
        IEnumerable<double> values =
        [
            .. new RandomUIntCollection(new UShort(10000)).Select(x =>
                Convert.ToDouble(x.NumberValue)
            ),
        ];
