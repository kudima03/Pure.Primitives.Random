...
public sealed record RandomIntCollectionTests
{
    ...
    public void RangeAffectGeneration()
    {
        ...
        IEnumerable<int> values = new RandomIntCollection(
            new MaxUshort(),
            min,
            max
    ...
    public void ProduceNormalStandardDeviationWithSharedProvider()
    {
        ...
        [
            .. new RandomIntCollection(new UShort(10000), random).Select(x =>
                x.NumberValue
            ),
        ];
    ...
    public void ProduceNormalStandardDeviation()
    {
        IEnumerable<int> values =
        [
            .. new RandomIntCollection(new UShort(10000)).Select(x => x.NumberValue),
        ];
